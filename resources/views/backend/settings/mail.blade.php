                    ...
                    <div class="card-body">
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mail_mailer" id="mail_mailer"
                                           ...
                                           value="{{ config('settings.mail_mailer') ?? old('mail_mailer') }}"
                                           placeholder="Mailer">
                                    @error('mail_mailer')
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mail_encryption" id="mail_encryption"
                                           ...
                                           value="{{ config('settings.mail_encryption') ?? old('mail_encryption') }}"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mail_host" id="mail_host"
                                           ...
                                           value="{{ config('settings.mail_host') ?? old('mail_host') }}"
                            ...
                            <div class="col">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="mail_port" id="mail_port"
                                           ...
                                           value="{{ config('settings.mail_port') ?? old('mail_port') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mail_username" id="mail_username"
                                   ...
                                   value="{{ config('settings.mail_username') ?? old('mail_username') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="password" name="mail_password" id="mail_password"
                                   ...
                                   value="{{ config('settings.mail_password') ?? old('mail_password') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" name="mail_from_address" id="mail_from_address"
                                   ...
                                   value="{{ config('settings.mail_from_address') ?? old('mail_from_address') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="mail_from_name" id="mail_from_name"
                                   ...
                                   value="{{ config('settings.mail_from_name') ?? old('mail_from_name') }}"
